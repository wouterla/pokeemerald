...
static const struct TrainerMonNoItemCustomMoves sParty_Dusty1[] = {
    ...
    .lvl = 34,
    .species = SPECIES_STEELIX,
    .moves = {MOVE_DIG, MOVE_IRON_TAIL, MOVE_SAND_ATTACK, MOVE_ROCK_THROW}
    }
};
...
static const struct TrainerMonNoItemCustomMoves sParty_Chip[] = {
    ...
    .moves = {MOVE_FAINT_ATTACK, MOVE_COUNTER, MOVE_SLAM, MOVE_YAWN}
    }
};
...
static const struct TrainerMonNoItemCustomMoves sParty_Foster[] = {
    ...
    .moves = {MOVE_ROCK_TOMB, MOVE_SLAM, MOVE_DEFENSE_CURL, MOVE_ROLLOUT}
    },
    {
    .iv = 100,
    .lvl = 35,
    .species = SPECIES_DONPHAN,
    .moves = {MOVE_HORN_ATTACK, MOVE_IRON_TAIL, MOVE_SAND_ATTACK, MOVE_GROWL}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Randall[] = {
    ...
    .species = SPECIES_FARFETCHD,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_SWORDS_DANCE, MOVE_AGILITY, MOVE_QUICK_ATTACK, MOVE_AERIAL_ACE}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Parker[] = {
    ...
    .species = SPECIES_JIGGLYPUFF,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_SING, MOVE_REST, MOVE_MIMIC, MOVE_DISABLE}
    },
    {
    .iv = 255,
    .lvl = 43,
    .species = SPECIES_EEVEE,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_SAND_ATTACK, MOVE_MIMIC, MOVE_SWAGGER, MOVE_SUBSTITUTE}
    },
    {
    .iv = 255,
    .lvl = 43,
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_CONVERSION_2, MOVE_DOUBLE_TEAM, MOVE_CONFUSION, MOVE_NONE}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_George[] = {
    ...
    .moves = {MOVE_REST, MOVE_SLEEP_TALK, MOVE_BODY_SLAM, MOVE_BRICK_BREAK}
    },
    {
    .iv = 255,
    .lvl = 43,
    ...
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_SOFT_BOILED, MOVE_HEAL_BELL, MOVE_PRESENT, MOVE_EGG_BOMB}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Berke[] = {
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_WING_ATTACK, MOVE_EARTHQUAKE, MOVE_FLAMETHROWER, MOVE_GIGA_DRAIN}
    },
    {
    .iv = 255,
    .lvl = 43,
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_HAIL, MOVE_SUNNY_DAY, MOVE_WEATHER_BALL, MOVE_RAIN_DANCE}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Mary[] = {
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_STRENGTH, MOVE_SHOCK_WAVE, MOVE_PURSUIT, MOVE_NONE}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Alexia[] = {
    ...
    .species = SPECIES_KANGASKHAN,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_CRUSH_CLAW, MOVE_SAFEGUARD, MOVE_SUBSTITUTE, MOVE_PROTECT}
    },
    {
    .iv = 255,
    .lvl = 26,
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_THRASH, MOVE_PROTECT, MOVE_SUBSTITUTE, MOVE_ENDURE}
    },
    {
    .iv = 255,
    .lvl = 26,
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_LICK, MOVE_STOMP, MOVE_SUBSTITUTE, MOVE_PROTECT}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Jody[] = {
    ...
    .species = SPECIES_SLAKING,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_FOCUS_PUNCH, MOVE_FIRE_BLAST, MOVE_SOLAR_BEAM, MOVE_HYPER_BEAM}
    },
    {
    .iv = 255,
    .lvl = 43,
    .species = SPECIES_EXPLOUD,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_HYPER_BEAM, MOVE_EXTRASENSORY, MOVE_STRENGTH, MOVE_SOLAR_BEAM}
    }
};
...
static const struct TrainerMonNoItemCustomMoves sParty_Kirk[] = {
    ...
    .moves = {MOVE_QUICK_ATTACK, MOVE_THUNDER_WAVE, MOVE_SPARK, MOVE_HELPING_HAND}
    },
    {
    .iv = 100,
    .lvl = 26,
    .species = SPECIES_ELEKID,
    .moves = {MOVE_THUNDER_PUNCH, MOVE_SWIFT, MOVE_QUICK_ATTACK, MOVE_LIGHT_SCREEN}
    }
};
...
static const struct TrainerMonNoItemCustomMoves sParty_Drew[] = {
    ...
    .moves = {MOVE_DIG, MOVE_SAND_ATTACK, MOVE_BITE, MOVE_SLASH}
    }
};
...
static const struct TrainerMonNoItemCustomMoves sParty_Edward[] = {
    ...
    .moves = {MOVE_HIDDEN_POWER, MOVE_CONFUSION, MOVE_DISABLE, MOVE_NONE}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Sidney[] = {
    ...
    .species = SPECIES_UMBREON,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_PROTECT, MOVE_DOUBLE_EDGE, MOVE_MOONLIGHT, MOVE_CRUNCH}
    },
    {
    .iv = 250,
    .lvl = 80,
    .species = SPECIES_TYRANITAR,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_EARTHQUAKE, MOVE_CRUNCH, MOVE_ROCK_SLIDE, MOVE_BRICK_BREAK}
    },
    {
    .iv = 250,
    .lvl = 75,
    ...
    .moves = {MOVE_NEEDLE_ARM, MOVE_SANDSTORM, MOVE_SOLAR_BEAM, MOVE_DESTINY_BOND}
    },
    {
    .iv = 250,
    .lvl = 78,
...
static const struct TrainerMonItemCustomMoves sParty_Phoebe[] = {
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_SHADOW_PUNCH, MOVE_FUTURE_SIGHT, MOVE_CURSE, MOVE_PROTECT}
    },
    {
    .iv = 250,
    .lvl = 77,
    ...
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_PERISH_SONG, MOVE_PSYBEAM, MOVE_THUNDERBOLT, MOVE_PROTECT}
    },
    {
    .iv = 250,
    .lvl = 81,
    ...
    .moves = {MOVE_SHADOW_BALL, MOVE_NIGHTMARE, MOVE_HYPNOSIS, MOVE_DREAM_EATER}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Glacia[] = {
    ...
    .species = SPECIES_DEWGONG,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_REST, MOVE_BODY_SLAM, MOVE_HAIL, MOVE_ICE_BEAM}
    },
    {
    .iv = 250,
    .lvl = 77,
    .species = SPECIES_WALREIN,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_ENCORE, MOVE_EARTHQUAKE, MOVE_BLIZZARD, MOVE_ICE_BEAM}
    },
    {
    .iv = 250,
    .lvl = 82,
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_ZAP_CANNON, MOVE_SUPERPOWER, MOVE_AMNESIA, MOVE_HYPER_BEAM}
    },
    {
    .iv = 250,
    .lvl = 77,
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_AURORA_BEAM, MOVE_PROTECT, MOVE_WATER_PULSE, MOVE_ICE_BEAM}
    },
    {
    .iv = 255,
    .lvl = 80,
    ...
    .moves {MOVE_BLIZZARD, MOVE_ICE_BEAM, MOVE_STRENGTH, MOVE_EARTHQUAKE}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Drake[] = {
    ...
    .species = SPECIES_DRAGONITE,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_WING_ATTACK, MOVE_DRAGON_CLAW, MOVE_PROTECT, MOVE_THUNDER_WAVE}
    },
    {
    .iv = 250,
    .lvl = 80,
    .species = SPECIES_ALTARIA,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_SING, MOVE_DRAGON_BREATH, MOVE_DRAGON_DANCE, MOVE_SKY_ATTACK}
    },
    {
    .iv = 250,
    .lvl = 80,
    ...
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_PSYCHIC, MOVE_DRAGON_CLAW, MOVE_RECOVER, MOVE_SAFEGUARD}
    },
    {
    .iv = 255,
    .lvl = 83,
    .species = SPECIES_LATIAS,
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_TOXIC, MOVE_PROTECT, MOVE_REST, MOVE_SAFEGUARD}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Roxanne1[] = {
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_TACKLE, MOVE_SCREECH, MOVE_BIND}
    },
    {
    .iv = 100,
    .lvl = 11,
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_SCRATCH, MOVE_HARDEN, MOVE_ROCK_SLIDE, MOVE_KNOCK_OFF}
    },
    {
    .iv = 100,
    .lvl = 11,
    ...
    .moves = {MOVE_ASTONISH, MOVE_CONSTRICT, MOVE_ROCK_SLIDE, MOVE_FACADE}
    },
    {
    .iv = 100,
    .lvl = 12,
    ...
    .heldItem = ITEM_ORAN_BERRY,
    .moves = {MOVE_CONSTRICT, MOVE_WITHDRAW, MOVE_BUBBLE_BEAM, MOVE_ROCK_SLIDE}
    },
    {
    .iv = 100,
    .lvl = 13,
    ...
    .heldItem = ITEM_ORAN_BERRY,
    .moves = {MOVE_BITE, MOVE_LEER, MOVE_SANDSTORM, MOVE_ROCK_TOMB}
    },
    {
    .iv = 200,
    .lvl = 15,
    ...
    .heldItem = ITEM_ORAN_BERRY,
    .moves = {MOVE_EXPLOSION, MOVE_STRENGTH, MOVE_ROCK_SMASH, MOVE_ROCK_THROW}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Brawly1[] = {
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_BIDE, MOVE_MEDITATE, MOVE_CONFUSION, MOVE_DETECT}
    },
    {
    .iv = 100,
    .lvl = 17,
    .species = SPECIES_BRELOOM,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_TACKLE, MOVE_LEECH_SEED, MOVE_MEGA_DRAIN, MOVE_STUN_SPORE}
    },
    {
    .iv = 100,
    .lvl = 18,
    .species = SPECIES_HERACROSS,
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_HORN_ATTACK, MOVE_ENDURE, MOVE_BULK_UP, MOVE_BRICK_BREAK}
    },
    {
    .iv = 100,
    .lvl = 16,
    .species = SPECIES_POLIWRATH,
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_DOUBLE_SLAP, MOVE_HYPNOSIS, MOVE_SUBMISSION, MOVE_WATER_GUN}
    },
    {
    .iv = 100,
    .lvl = 18,
    .species = SPECIES_MACHOP,
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_LOW_KICK, MOVE_KARATE_CHOP, MOVE_FOCUS_ENERGY, MOVE_COUNTER}
    },
    {
    .iv = 200,
    .lvl = 20,
    ...
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_PECK, MOVE_SAND_ATTACK, MOVE_FOCUS_ENERGY, MOVE_DOUBLE_KICK}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Wattson1[] = {
    ...
    .species = SPECIES_PICHU,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_THUNDER_SHOCK, MOVE_THUNDER_WAVE, MOVE_CHARM, MOVE_SWEET_KISS}
    },
    {
    .iv = 200,
    .lvl = 27,
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_SONIC_BOOM, MOVE_SPARK, MOVE_SELF_DESTRUCT, MOVE_SCREECH}
    },
    {
    .iv = 220,
    .lvl = 28,
    .species = SPECIES_JOLTEON,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_THUNDERBOLT, MOVE_DIG, MOVE_THUNDER_WAVE, MOVE_SAND_ATTACK}
    },
    {
    .iv = 220,
    .lvl = 27,
    .species = SPECIES_MAGNEMITE,
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_SONIC_BOOM, MOVE_THUNDER_WAVE, MOVE_SPARK, MOVE_METAL_SOUND}
    },
    {
    .iv = 220,
    .lvl = 27,
    ...
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_THUNDER_PUNCH, MOVE_COTTON_SPORE, MOVE_TAKE_DOWN, MOVE_SAFEGUARD}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Flannery1[] = {
    ...
    .species = SPECIES_MAGBY,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_SUNNY_DAY, MOVE_SMOKESCREEN, MOVE_SMOG, MOVE_FIRE_PUNCH}
    },
    {
    .iv = 200,
    .lvl = 37,
    .species = SPECIES_FLAREON,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_BITE, MOVE_FIRE_SPIN, MOVE_SAND_ATTACK, MOVE_EMBER}
    },
    {
    .iv = 225,
    .lvl = 38,
    .species = SPECIES_ARCANINE,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_FLAME_WHEEL, MOVE_TAKE_DOWN, MOVE_ROAR, MOVE_BITE}
    },
    {
    .iv = 200,
    .lvl = 36,
    ...
    .moves = {MOVE_EARTHQUAKE, MOVE_FOCUS_ENERGY, MOVE_EMBER, MOVE_DEFENSE_CURL}
    },
    {
    .iv = 225,
    .lvl = 39,
    .species = SPECIES_TYPHLOSION,
    .heldItem = ITEM_WHITE_HERB,
    .moves = {MOVE_FLAME_WHEEL, MOVE_QUICK_ATTACK, MOVE_SMOKESCREEN, MOVE_CRUSH_CLAW}
    },
    {
    .iv = 250,
    .lvl = 40,
    ...
    .heldItem = ITEM_WHITE_HERB,
    .moves = {MOVE_RECOVER, MOVE_AERIAL_ACE, MOVE_STRENGTH, MOVE_FIRE_BLAST}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Norman1[] = {
    ...
    .species = SPECIES_SNORLAX,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_BELLY_DRUM, MOVE_REST, MOVE_SNORE, MOVE_BODY_SLAM}
    },
    {
    .iv = 200,
    .lvl = 43,
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_METRONOME, MOVE_SWEET_KISS, MOVE_YAWN, MOVE_ENCORE}
    },
    {
    .iv = 200,
    .lvl = 41,
    .species = SPECIES_JIGGLYPUFF,
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_SING, MOVE_ROLLOUT, MOVE_DISABLE, MOVE_BODY_SLAM}
    },
    {
    .iv = 200,
    .lvl = 42,
    .species = SPECIES_LICKITUNG,
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_SLAM, MOVE_KNOCK_OFF, MOVE_DISABLE, MOVE_WRAP}
    },
    {
    .iv = 250,
    .lvl = 45,
...
static const struct TrainerMonItemCustomMoves sParty_Winona1[] = {
    ...
    .species = SPECIES_CROBAT,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_WING_ATTACK, MOVE_BITE, MOVE_POISON_FANG, MOVE_SCREECH}
    },
    {
    .iv = 210,
    .lvl = 50,
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_WING_ATTACK, MOVE_BITE, MOVE_ANCIENT_POWER, MOVE_HYPER_BEAM}
    },
    {
    .iv = 220,
    .lvl = 50,
    .species = SPECIES_ALTARIA,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_DRAGON_DANCE, MOVE_DRAGON_BREATH, MOVE_SING, MOVE_REFRESH}
    },
    {
    .iv = 255,
    .lvl = 55,
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_ICE_BEAM, MOVE_MIND_READER, MOVE_FLY, MOVE_SHEER_COLD}
    },
    {
    .iv = 255,
    .lvl = 55,
    ...
    .heldItem = ITEM_ORAN_BERRY,
    .moves = {MOVE_DRILL_PECK, MOVE_THUNDERBOLT, MOVE_AGILITY, MOVE_STEEL_WING}
    },
    {
    .iv = 255,
    .lvl = 55,
    ...
    .heldItem = ITEM_ORAN_BERRY,
    .moves = {MOVE_FLAMETHROWER, MOVE_WING_ATTACK, MOVE_AGILITY, MOVE_DOUBLE_TEAM}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_TateAndLiza1[] = {
    ...
    .species = SPECIES_SLOWKING,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_PSYCHIC, MOVE_HEADBUTT, MOVE_SWAGGER, MOVE_DIVE}
    },
    {
    .iv = 250,
    .lvl = 60,
    .species = SPECIES_LUNATONE,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_PSYCHIC, MOVE_FUTURE_SIGHT, MOVE_COSMIC_POWER, MOVE_ROCK_THROW}
    },
    {
    .iv = 250,
    .lvl = 63,
    .species = SPECIES_ALAKAZAM,
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_PSYCHIC, MOVE_CALM_MIND, MOVE_DISABLE, MOVE_RECOVER}
    },
    {
    .iv = 250,
    .lvl = 63,
    .species = SPECIES_WOBBUFFET,
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_COUNTER, MOVE_DESTINY_BOND, MOVE_MIRROR_COAT, MOVE_SAFEGUARD}
    },
    {
    .iv = 250,
    .lvl = 65,
    ...
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_PERISH_SONG, MOVE_ANCIENT_POWER, MOVE_FUTURE_SIGHT, MOVE_LEECH_SEED}
    },
    {
    .iv = 250,
    .lvl = 65,
    ...
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_HYDRO_PUMP, MOVE_RECOVER, MOVE_THUNDERBOLT, MOVE_PROTECT}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Juan1[] = {
    ...
    .species = SPECIES_LAPRAS,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_SHEER_COLD, MOVE_BODY_SLAM, MOVE_PERISH_SONG, MOVE_RAIN_DANCE}
    },
    {
    .iv = 200,
    .lvl = 70,
    .species = SPECIES_GOLDUCK,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_PSYCH_UP, MOVE_PSYCHIC, MOVE_HYPNOSIS, MOVE_SCREECH}
    },
    {
    .iv = 200,
    .lvl = 73,
    .species = SPECIES_KINGDRA,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_DRAGON_DANCE, MOVE_HYDRO_PUMP, MOVE_DRAGON_BREATH, MOVE_AURORA_BEAM}
    },
    {
    .iv = 200,
    .lvl = 71,
    .species = SPECIES_QUAGSIRE,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_EARTHQUAKE, MOVE_YAWN, MOVE_SLAM, MOVE_ANCIENT_POWER}
    },
    {
    .iv = 250,
    .lvl = 74,
    ...
    .moves = {MOVE_SLASH, MOVE_CRUNCH, MOVE_SCREECH, MOVE_HYDRO_PUMP}
    },
    {
    .iv = 250,
    .lvl = 75,
...
static const struct TrainerMonNoItemCustomMoves sParty_Josh[] = {
    ...
    .lvl = 10,
    .species = SPECIES_AERODACTYL,
    .moves = {MOVE_WING_ATTACK, MOVE_AGILITY, MOVE_PURSUIT, MOVE_NONE}
    },
    {
    .iv = 100,
    .lvl = 10,
    .species = SPECIES_CORSOLA,
    .moves = {MOVE_TACKLE, MOVE_HARDEN, MOVE_ROLLOUT, MOVE_NONE}
    }
};
...
static const struct TrainerMonNoItemCustomMoves sParty_Ben[] = {
    ...
    .lvl = 27,
    .species = SPECIES_PIKACHU,
    .moves = {MOVE_DOUBLE_TEAM, MOVE_QUICK_ATTACK, MOVE_GROWL, MOVE_THUNDERBOLT}
    },
    {
    .iv = 150,
    .lvl = 27,
    .species = SPECIES_CHINCHOU,
    .moves = {MOVE_WATER_GUN, MOVE_FLAIL, MOVE_SPARK, MOVE_SUPERSONIC}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Wallace[] = {
    ...
    .species = SPECIES_GENGAR,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_SHADOW_PUNCH, MOVE_DREAM_EATER, MOVE_HYPNOSIS, MOVE_TOXIC}
    },
    {
    .iv = 255,
    .lvl = 90,
    ...
    .species = SPECIES_UMBREON,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_FAINT_ATTACK, MOVE_MOONLIGHT, MOVE_IRON_TAIL, MOVE_DOUBLE_TEAM}
    },
    {
    .iv = 255,
    .lvl = 85,
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_REST, MOVE_SURF, MOVE_THUNDER, MOVE_ICE_BEAM}
    },
    {
    .iv = 255,
    .lvl = 85,
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_DRAGON_DANCE, MOVE_EXTREME_SPEED, MOVE_CRUNCH, MOVE_DRAGON_CLAW}
    },
    {
    .iv = 255,
    .lvl = 83,
    .species = SPECIES_AERODACTYL,
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_DRAGON_BREATH, MOVE_WING_ATTACK, MOVE_STEEL_WING, MOVE_ANCIENT_POWER}
    }
};
...
static const struct TrainerMonNoItemCustomMoves sParty_Madeline1[] = {
    ...
    .lvl = 33,
    .species = SPECIES_TAUROS,
    .moves = {MOVE_STRENGTH, MOVE_HORN_ATTACK, MOVE_ROCK_TOMB, MOVE_PROTECT}
    }
};
...
static const struct TrainerMonNoItemCustomMoves sParty_WallyVR1[] = {
    ...
    .lvl = 70,
    .species = SPECIES_CLOYSTER,
    .moves = {MOVE_SPIKES, MOVE_PROTECT, MOVE_TOXIC, MOVE_BARRIER}
    },
    {
    .iv = 150,
    .lvl = 70,
    .species = SPECIES_VAPOREON,
    .moves = {MOVE_HYDRO_PUMP, MOVE_AURORA_BEAM, MOVE_BITE, MOVE_ICE_BEAM}
    },
    {
    .iv = 150,
    .lvl = 70,
    .species = SPECIES_MISDREAVUS,
    .moves = {MOVE_LICK, MOVE_POUND, MOVE_HARDEN, MOVE_BIND}
    },
    {
    .iv = 150,
    .lvl = 70,
    .species = SPECIES_BLAZIKEN,
    .moves = {MOVE_SKY_UPPERCUT, MOVE_SLASH, MOVE_BLAZE_KICK, MOVE_COUNTER}
    },
    {
    .iv = 250,
    .lvl = 70,
    .species = SPECIES_GARDEVOIR,
    .moves = {MOVE_HYPNOSIS, MOVE_CALM_MIND, MOVE_PSYCHIC, MOVE_DREAM_EATER}
    },
    {
    .iv = 250,
    .lvl = 70,
    .species = SPECIES_SWALOT,
    .moves = {MOVE_SWALLOW, MOVE_STOCKPILE, MOVE_POUND, MOVE_SPIT_UP}
    }
};
...
static const struct TrainerMonNoItemCustomMoves sParty_Vivian[] = {
    ...
    .lvl = 26,
    .species = SPECIES_PLUSLE,
    .moves = {MOVE_ENCORE, MOVE_THUNDER_WAVE, MOVE_SPARK, MOVE_QUICK_ATTACK}
    },
    {
    .iv = 100,
    .lvl = 26,
...
static const struct TrainerMonNoItemCustomMoves sParty_WallyVR2[] = {
    ...
    .moves = {MOVE_SWALLOW, MOVE_STOCKPILE, MOVE_ATTRACT, MOVE_ABSORB}
    }
};
...
static const struct TrainerMonNoItemCustomMoves sParty_JohnAndJay2[] = {
    ...
    .lvl = 80,
    .species = SPECIES_ELECTABUZZ,
    .moves = {MOVE_PSYCHIC, MOVE_THUNDER_PUNCH, MOVE_SWIFT, MOVE_BRICK_BREAK}
    },
    {
    .iv = 210,
    .lvl = 80,
...
static const struct TrainerMonItemCustomMoves sParty_Angelo[] = {
    ...
    .species = SPECIES_MAGNEMITE,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_SPARK, MOVE_METAL_SOUND, MOVE_SONIC_BOOM, MOVE_SUPERSONIC}
    },
    {
    .iv = 100,
    .lvl = 28,
    .species = SPECIES_RAICHU,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_QUICK_ATTACK, MOVE_TAIL_WHIP, MOVE_THUNDER_SHOCK, MOVE_THUNDERBOLT}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Sapphire[] = {
    {
    .iv = 255,
    .lvl = 70,
    .species = SPECIES_CAMERUPT,
    .moves = {MOVE_FISSURE, MOVE_STRENGTH, MOVE_EARTHQUAKE, MOVE_ERUPTION},
    ...
    .lvl = 70,
    .species = SPECIES_CROBAT,
    .moves = {MOVE_BITE, MOVE_FLY, MOVE_POISON_FANG, MOVE_WING_ATTACK},
    ...
    .lvl = 70,
    .species = SPECIES_ARMALDO,
    .moves = {MOVE_WATER_PULSE, MOVE_WATER_PULSE, MOVE_ANCIENT_POWER, MOVE_SLASH},
    .heldItem = ITEM_QUICK_CLAW,
    },
    {
    .iv = 255,
    ...
    .lvl = 70,
    .species = SPECIES_SCEPTILE,
    .moves = {MOVE_HIDDEN_POWER, MOVE_DETECT, MOVE_LEAF_BLADE, MOVE_AERIAL_ACE},
    ...
    .lvl = 70,
    .species = SPECIES_KYOGRE,
    .moves = {MOVE_ICE_BEAM, MOVE_REST, MOVE_SURF, MOVE_THUNDER},
    .heldItem = ITEM_MYSTIC_WATER,
    }
};


static const struct TrainerMonItemCustomMoves sParty_Ruby[] = {
    {
    .iv = 255,
    .lvl = 70,
    .species = SPECIES_MACHOKE,
    .moves = {MOVE_LOW_KICK, MOVE_CROSS_CHOP, MOVE_FIRE_BLAST, MOVE_BRICK_BREAK},
    .heldItem = ITEM_CHARCOAL,
    },
    {
    .iv = 255,
    .lvl = 70,
    .species = SPECIES_AGGRON,
    .moves = {MOVE_STRENGTH, MOVE_DRAGON_CLAW, MOVE_FIRE_BLAST, MOVE_WATER_PULSE},
    ...
    .lvl = 70,
    .species = SPECIES_CRADILY,
    .moves = {MOVE_EARTHQUAKE, MOVE_ANCIENT_POWER, MOVE_ACID, MOVE_HYPER_BEAM},
    .heldItem = ITEM_SITRUS_BERRY,  
    },
    {
    .iv = 255,
    ...
    .lvl = 70,
    .species = SPECIES_GROUDON,
    .moves = {MOVE_SLASH, MOVE_REST, MOVE_EARTHQUAKE, MOVE_FIRE_BLAST},
